...
namespace ComputerComponentsApi.Migrations
{
    ...
    [Migration("20260520193730_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.Component", b =>
                {
                    b.HasOne("ComputerComponentsApi.Models.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ComputerComponentsApi.Models.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("ComputerComponentsApi.Models.PCComponent", b =>
                {
                    b.HasOne("ComputerComponentsApi.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ComputerComponentsApi.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
